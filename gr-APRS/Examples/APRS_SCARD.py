...
class APRS_SCARD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fft_filter_xxx_0 = filter.fft_filter_fff(1, firdes.band_pass(10,samp_rate,1e3,2.6e3,100,2), 1)
        ...
        self.msg_connect((self.epy_block_0, 'ax25 out'), (self.display_text_msg_0, 'text'))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.fft_filter_xxx_0.set_taps(firdes.band_pass(10,self.samp_rate,1e3,2.6e3,100,2))
