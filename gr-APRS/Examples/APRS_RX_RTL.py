...
class APRS_RX_RTL(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._rfgain_range = qtgui.Range(0, 62, 1, 25, 100)
        ...
        self.osmosdr_source_0.set_if_gain(rfgain, 0)
        self.osmosdr_source_0.set_bb_gain(32, 0)
        self.osmosdr_source_0.set_antenna('', 0)
        self.osmosdr_source_0.set_bandwidth(0, 0)
        self.fft_filter_xxx_1 = filter.fft_filter_fff(1, firdes.band_pass(1,ch_rate,400,5e3,400,2), 1)
        self.fft_filter_xxx_1.declare_sample_delay(0)
        self.display_text_msg_0 = display.text_msg( "", '', 1000)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.APRS_Rx_0, 'HDLC'), (self.display_text_msg_0, 'text'))
        self.msg_connect((self.qtgui_freq_sink_x_0_0, 'freq'), (self.blocks_message_debug_0, 'print'))
        ...
        self.connect((self.pfb_decimator_ccf_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
    ...
    def set_rfgain(self, rfgain):
        self.rfgain = rfgain
        self.osmosdr_source_0.set_if_gain(self.rfgain, 0)
    ...
    def set_freq(self, freq):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq, 192e3)
    ...
    def set_ch_rate(self, ch_rate):
        ...
        self.fft_filter_xxx_1.set_taps(firdes.band_pass(1,self.ch_rate,400,5e3,400,2))
