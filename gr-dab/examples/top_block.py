...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0.set_center_freq(206.35e6, 0)
        ...
        self._gain_slider_range = qtgui.Range(0, 100, 1, 50, 200)
        self._gain_slider_win = qtgui.RangeWidget(self._gain_slider_range, self.set_gain_slider, "Gain", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.dab_fic_decode_0.set_print_channel_info(True)
        self.dab_dabplus_audio_decoder_ff_0 = dab.dabplus_audio_decoder_ff(dab.parameters.dab_parameters(mode=1, sample_rate=samp_rate, verbose=False), 120, 0, 90, 2, True)
